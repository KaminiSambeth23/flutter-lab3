...
File _image;
String urlUpload = "http://theksultra.com/carpool/php/register_user.php";
...
class RegistrationPage extends StatefulWidget {
  ...
  const RegistrationPage({Key key,File image}) : super(key: key);
}
...
class _RegisterWidgetState extends State<RegisterWidget> {
  ...
  void _onRegister() {
    print('onRegister Button from RegistrationPage()');
    print(_image.toString());
    uploadData();}
                          
  void _onBackPress() {
    _image=null;
    print('onBackpress from RegistrationPage');
